...
class _PropertyForm3State extends State<PropertyForm3>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    ...
    if (sessionId != null) {
      ...
      await context.read<PropertyConfirmCubit>().propertyConfirm(
        sessionId: sessionId,
      );
    }
    ...
    //         MaterialPageRoute(
    //           builder:
    //               (context) => MyAdvertisementsPage(initialPublishedCount: 0),
    //         ),
    //       );
    //     } else {
    //       AppSnackBar.showFromTop(
    ...
    //         title: 'Error',
    //         message:
    //             "فشلت عملية الدفع. سيتم تعليق حجز الشقة مؤقتًا لحين إتمام الدفع.",
    ...
    //         MaterialPageRoute(
    //           builder:
    //               (context) => MyAdvertisementsPage(initialPublishedCount: 1),
    //         ),
    //       );
    //     }
    //   }
    ...
    return Directionality(
      ...
      child: Column(
        ...
        children: [
          ...
          BlocConsumer<PropertyCreateCubit, PropertyCreateState>(
                                ...
                                child: CustomAlertDialog(
                                  ...
                                  onConfirm: () {
                                    context
                                        ...
                                        .propertyCreate(
                                          property: widget.formData.copyWith(
                                            images: images,
                                          ),
                                        );
                                  },
                                    ...
                                    if (paymentUrl != null &&
                                      ...
                                      if (match != null) {
                                        ...
                                        AppSnackBar.showFromTop(
                                          ...
                                          title: 'Warning',
                                          message:
                                              'تم تعليق الإعلان لحين إتمام عملية الدفع',
                                        ...
                                        AppSnackBar.showFromTop(
                                          ...
                                          title: 'Error',
                                          message:
                                              'لم يتم العثور على session ID في الرابط.',
                                          contentType: ContentType.failure,
                                        );
                                      }
                                    }
