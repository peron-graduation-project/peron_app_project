                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: CustomButton(
                              textColor:Colors.white , text: 'حذف', backgroundColor: AppColors.primaryColor,
                            onPressed: (){
                      ...
                      SizedBox(width:12),
                      Expanded(
                          child: CustomButton(textColor: AppColors.primaryColor , text: 'إلغاء', backgroundColor: Colors.white,borderColor:AppColors.primaryColor ,)
                      ),
                    ],
                  ),
                ],
